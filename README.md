...
## How to Run
#### Use [[Redshift_Cluster_IaC.py](https://github.com/san089/Data_Engineering_Projects/blob/master/Redshift_Cluster_IaC.py "Redshift_Cluster_IaC.py")](https://github.com/Rahul9970Aws/Udacity_AWS_Data_Engineering_Projects/blob/main/Redshift_Cluster_IaC.py) to launch Redshift Cluster.
